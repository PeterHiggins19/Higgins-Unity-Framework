HUF-DOC: HUF.DRAFT.WIKI.NOTE.FOURTH_MONITORING_CATEGORY | HUF:1.1.8 | DOC:v1.0 | STATUS:draft | LANE:DRAFT | RO:Peter Higgins
CODES: huf, MC-4, monitoring, epistemology, wiki | ART: CM, AS, TR, EB | EVID:E1 | POSTURE: THM | WEIGHTS: OP=0.80 TOOL=0.15 PEER=0.05 | CAP: OP_MIN=0.51 TOOL_MAX=0.49 | CANON:notes/current_documents/staged/HUF.DRAFT.WIKI.NOTE.FOURTH_MONITORING_CATEGORY/
...
**Ratio state monitoring** was a candidate name. It is short, technical, and accurate. It distinguishes the category from all three established categories: passive monitoring observes events, mandated monitoring observes thresholds, question-driven monitoring observes hypotheses, and ratio state monitoring observes the internal distribution of system mass.

**RESOLVED March 28, 2026:** The official category name is **Composition Monitoring** (MC-4). The term "ratio-state" describes the mathematical state the instrument reads (the normalized proportional vector on the simplex), not the category itself. Usage convention: "Composition Monitoring" for the category, "ratio-state" for the mathematical state being observed. See MONITOR-001 naming_convention for the formal record.
