#!/usr/bin/env node
// ══════════════════════════════════════════════════════════════════════
// HUF Collective Trace v5.3 + HUF-Org — Builder
...
function titlePage() {
  return [
    ...
    SP(),
    P([{ text: 'Collective Trace Report v5.3', font: 'Times New Roman', size: 28, bold: true, color: MID }], { align: AlignmentType.CENTER }),
...
function section2ProjectState() {
  return [
    ...
    new Paragraph({ spacing: { after: 160 }, indent: { left: 720 },
      children: [new TextRun({ text: '• Sufficiency Frontier v3.4 — Defines the boundary between sustainable and collapsed systems', font: 'Times New Roman', size: 22, color: DK })] }),
    new Paragraph({ spacing: { after: 160 }, indent: { left: 720 },
      children: [new TextRun({ text: '• Fourth Category v2.4 — Establishes the mathematical framework beyond traditional triads', font: 'Times New Roman', size: 22, color: DK })] }),
...
async function build() {
  ...
  const out = '/sessions/wonderful-elegant-pascal/mnt/Claude CoWorker/HUFv4/HUF_Collective_Trace_v5.3.docx';
