...
function section4KeyDevelopments() {
  return [
    ...
    P('From Category AM (Peter\'s concept, formalized by Gemini R8): Ratio Velocity — structural redistribution that is invisible to absolute-magnitude sensors. Peter identified the concept; Gemini provided the formal articulation. The Temporal Sieve IS the topological differential (d_r) applied to the allocation vector. This is the operational concept for M2 (Spectral Drift Engine).'),
