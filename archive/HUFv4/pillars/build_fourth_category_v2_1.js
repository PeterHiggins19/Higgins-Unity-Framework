...
ch.push(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
    children: [new TextRun({ text: 'Pillar 2 of the HUF Triad \u00B7 Version 2.2', font: 'Times New Roman', size: 24, italics: true, color: DK })] }),
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
...
// ── 10. MC-4 IN EVERYDAY EXPERIENCE: CAR DASHBOARD (NEW IN v2.1) ─────
ch.push(
  new Paragraph({ children: [new PageBreak()] }),
...
// ── 11. OPEN CONJECTURES (NEW IN v2.0) ──────────────────────────────
ch.push(
  new Paragraph({ children: [new PageBreak()] }),
  H1('11. Open Conjectures from the Collective Review (New in v2.0)'),
...
ch.push(
  ...
  H2('12.3 Relationship to Companion Work'),
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: '\tThe Fourth Monitoring Category v2.2', font: 'Times New Roman', size: 18, italics: true, color: MID }),
        ],
...
const OUT = __dirname.replace(/[/\\]pillars$/, '') + '/HUF_Fourth_Category_v2.2.docx';
