...
This suggests that the geometric mean — a central operation in CoDa — may act as an entropy-stabilizing temporal filter for compositional time series with temporal structure. We are presenting this as an empirical finding with a mapped boundary, not as a theorem.
