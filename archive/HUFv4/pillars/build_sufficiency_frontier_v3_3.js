...
// ══════════════════════════════════════════════════════════════════════
// CONTENT — Pillar 1 v3.3 with Adaptive Scope section
// ══════════════════════════════════════════════════════════════════════
const children = [];
...
children.push(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
    children: [new TextRun({ text: 'Pillar 1 of the HUF Triad \u00B7 Version 3.3', font: 'Times New Roman', size: 24, italics: true, color: DARK })] }),
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
...
children.push(
  ...
  P('The sufficiency frontier is not a property of HUF; it is a property of the inference task. HUF demonstrates that the frontier exists and can be reached without domain-specific knowledge, provided the structural invariant (\u03A3\u03C1\u1D62 = 1) holds. The car/fuel analogy illustrates that the frontier is an everyday reality obscured by our habit of thinking in absolute numbers rather than ratios. In any system where budget is conserved and allocation is proportional, the frontier exists, the ratio reveals it, and the adaptive scope framework allows it to be monitored at any scale.'),
);
...
children.push(
  ...
  P('[15] P. Higgins, "The Fourth Monitoring Category: Ratio State Monitoring," HUF Triad Pillar 2, v2.3, 2026.'),
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: '\tThe Sufficiency Frontier v3.3', font: 'Times New Roman', size: 18, italics: true, color: MID }),
        ],
...
const OUT = __dirname.replace(/[/\\]pillars$/, '') + '/HUF_Sufficiency_Frontier_v3.3.docx';
