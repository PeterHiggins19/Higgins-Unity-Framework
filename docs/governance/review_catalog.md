...
**CI-2:** Financial Sectors (K=9, 74mo) — HOLDS at 0.08%. First financial domain.
**CI-3:** Planck CMB (K=2, half-split) — HOLDS at 0.3%. First cosmological domain. Spatial EITT fails (diagnostic).
**CI-4:** Gold/Silver (K=2, 338yr) — FAILS at 6.7%. K=4 reconstruction HOLDS at 0.38%. EITT inversion principle.
...
Claude: Five domains tested. Three new confirmations. One failure inverted into the session's most important conceptual advance.

**Category count: 92 total. 5 domains. EITT inversion principle established.**
