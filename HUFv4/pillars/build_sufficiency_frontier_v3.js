...
// ══════════════════════════════════════════════════════════════════════
// CONTENT — Pillar 1 v3.0 expanded with data provenance and Triad refs
// ══════════════════════════════════════════════════════════════════════
const children = [];
...
children.push(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
    children: [new TextRun({ text: 'Pillar 1 of the HUF Triad \u00B7 Version 3.0', font: 'Times New Roman', size: 24, italics: true, color: DARK })] }),
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
...
children.push(
  ...
  P('The sufficiency frontier is not a property of HUF; it is a property of the inference task. HUF demonstrates that the frontier exists and can be reached without domain-specific knowledge, provided the structural invariant (\u03A3\u03C1\u1D62 = 1) holds.'),
);
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: '\tThe Sufficiency Frontier v3.0', font: 'Times New Roman', size: 18, italics: true, color: MID }),
        ],
...
const OUT = __dirname.replace(/[/\\]pillars$/, '') + '/HUF_Sufficiency_Frontier_v3.0.docx';
