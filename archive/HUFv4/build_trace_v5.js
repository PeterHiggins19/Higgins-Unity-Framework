#!/usr/bin/env node
// ══════════════════════════════════════════════════════════════════════
// HUF Collective Trace v5.0 — Builder
...
function titlePage() {
  return [
    ...
    SP(),
    P([{ text: 'Collective Trace Report v5.0', font: 'Times New Roman', size: 28, bold: true, color: MID }], { align: AlignmentType.CENTER }),
...
async function build() {
    ...
    sections: [{
      ...
      headers: { default: new Header({ children: [
        new Paragraph({ alignment: AlignmentType.CENTER,
          ...
          spacing: { after: 0 },
          children: [new TextRun({ text: 'HUF Collective Trace — v5.0', font: 'Times New Roman', size: 18, color: MID, italics: true })] })
      ] }) },
  ...
  const out = '/sessions/wonderful-elegant-pascal/mnt/Claude CoWorker/HUFv4/HUF_Collective_Trace_v5.0.docx';
