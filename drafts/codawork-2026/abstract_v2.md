...
**REVISION NOTE:** Updated from v1 to incorporate the union thesis and 17-error calibration framing. Revised during Grok + ChatGPT collective review, April 3, 2026.
...
- **17-error calibration study mentioned** — signals to reviewers that this is a calibrated instrument, not an untested pitch.
