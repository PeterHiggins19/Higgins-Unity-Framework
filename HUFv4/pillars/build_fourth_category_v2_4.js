...
ch.push(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
    children: [new TextRun({ text: 'Pillar 2 of the HUF Triad \u00B7 Version 2.4 \u00B7 HUF-Org', font: 'Times New Roman', size: 24, italics: true, color: DK })] }),
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: '\tThe Fourth Monitoring Category v2.4', font: 'Times New Roman', size: 18, italics: true, color: MID }),
        ],
...
const OUT = __dirname.replace(/[/\\]pillars$/, '') + '/HUF_Fourth_Category_v2.4.docx';
