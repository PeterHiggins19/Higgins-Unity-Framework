...
children.push(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
    children: [new TextRun({ text: 'Pillar 1 of the HUF Triad \u00B7 Version 3.4 \u00B7 HUF-Org', font: 'Times New Roman', size: 24, italics: true, color: DARK })] }),
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 80 },
...
children.push(
  ...
  crossRef('MC-4 immune system: Pillar 2, The Fourth Monitoring Category v2.4'),
...
children.push(
  ...
  P('[15] P. Higgins, "The Fourth Monitoring Category: Ratio State Monitoring," HUF Triad Pillar 2, v2.4, 2026.'),
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: '\tThe Sufficiency Frontier v3.4', font: 'Times New Roman', size: 18, italics: true, color: MID }),
        ],
...
const OUT = __dirname.replace(/[/\\]pillars$/, '') + '/HUF_Sufficiency_Frontier_v3.4.docx';
