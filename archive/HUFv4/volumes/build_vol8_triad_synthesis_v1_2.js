...
children.push(
  ...
  P(''),
  H2('11.5 The Deceptive Drift: OCC Budget Depletion'),
  P('You declared 51% operator, 49% OCC budget. The system starts in perfect balance. But as the OCC budget depletes, something unexpected happens: the operator\u2019s share rises.'),
  P('At full fuel: 51% operator, 49% fuel. You are in control.'),
  P('After 20% fuel burn: 55% operator, 45% fuel. The operator share grows.'),
  P('After 50% fuel burn: 60% operator, 40% fuel. Control is tightening.'),
  P('After 75% fuel burn: 75% operator, 25% fuel. Operator dominance peaks.'),
  P('After 95% fuel burn: 95% operator, 5% fuel. The system is at the cliff.'),
  P('Each step looks like the operator is gaining control. \"I am 60% of the system now. I am 75%. I am 95%.\" But the operator gained nothing. The fuel ran out. This is the deceptive drift: a rising operator share that signals not success but depletion.'),
  P('The rising operator share IS the death signal, not the victory signal. A system at 95/5 has only 5% remaining before ground state. The operator feels empowered by the rising ratio. But the system is dying.'),
  ...
  P('This is OCC drift: the operator control contract budget depletes until it can no longer support the partnership. MC-4\u2019s job is to make this trajectory visible before the abrupt inform, to watch the ratio drift and warn: \"Your share is rising because fuel is falling. The cliff approaches.\"'),
  ...
  P(''),
  H2('11.6 Empty Tank and the Sufficiency Frontier'),
  ...
  P(''),
  H2('11.7 The Non-Intuitive Truth: Tank Size Matters'),
  ...
  P(''),
  H2('11.8 MC-4 Watching Compositional Drift'),
...
// ── 10. OPEN PROBLEMS AND FUTURE WORK (renumbered from 10 to 12) ───────────────────────────────────
children.push(
  new Paragraph({ children: [new PageBreak()] }),
  H1('12. Open Problems and Future Work'),
  H2('12.1 Mathematical'),
...
// ── 11. THE FIVE-AI COLLECTIVE (renumbered from 11 to 13) ──────────────────────────────────────
children.push(
  new Paragraph({ children: [new PageBreak()] }),
  H1('13. The Five-AI Collective'),
...
// ── 12. CONCLUSION (renumbered from 12 to 14) ──────────────────────────────────────
children.push(
  new Paragraph({ children: [new PageBreak()] }),
  H1('14. Conclusion'),
...
const OUT = __dirname.replace(/[/\\]volumes$/, '') + '/HUF_Triad_Synthesis_v1.2.docx';
